        ...
        >
          ...
          >
            <Stack spacing={4}>
              ...
              <Text color={"gray.500"} fontSize={{ base: "sm", sm: "md" }}>
                Bookmark your Learning Save, Share and Grow with the community.
              </Text>
            </Stack>
            ...
            <Text color={"gray.500"} fontSize={{ base: "sm", sm: "md" }}>
              We are a group of self taught coders and full stack developers who
              are passionate about learning new things and sharing our knowledge
              with others.
            </Text>
          </Stack>
        </Container>
