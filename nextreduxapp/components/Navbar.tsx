    ...
    <Box>
      ...
      >
        ...
        >
          <Popover isLazy>
            <PopoverTrigger>
              <Box role="button" aria-label="User Profile" w="10">
                <Image
                  borderRadius="full"
...
const NAV_ITEMS: Array<NavItem> = [
  {
    ...
    children: [
      {
        label: "Ideas",
        subLabel: "Find inspiration for your next project",
        href: "#",
      },
    ],
  },
